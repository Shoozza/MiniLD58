...
begin
  if Coin.Active > 30 then
    ...
    al_draw_filled_rectangle(Coin.x, Coin.y, Coin.x+Coin.w, Coin.y+Coin.h, CoinShadeColor);
  if Coin.vy > 0 then
    al_draw_filled_rectangle(Coin.x, Coin.y-Coin.vy*10, Coin.x+Coin.w, Coin.y, CoinShadeColor)
  else if Coin.vy < 0 then
    al_draw_filled_rectangle(Coin.x, Coin.y+Coin.h, Coin.x+Coin.w, Coin.y+Coin.h-Coin.vy*10, CoinShadeColor);
end;
